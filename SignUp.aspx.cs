...
public partial class SignUp : System.Web.UI.Page
{
    ...
    protected void txtsignup_Click(object sender, EventArgs e)
    {
        ...
        if (isformvalid())
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("Insert into tblUsers(Username,Password,Email,Name,Usertype,Phone) Values('" + txtUname.Text + "','" + txtPass.Text + "','" + txtEmail.Text + "','" + txtName.Text + "','" + txtPhone.Text + "','User')", con);
                cmd.ExecuteNonQuery();
